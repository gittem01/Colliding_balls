...
class obj:
    def __init__(self, mass, vx, vy, x, y, r, color, song):
        self.mass = mass
        self.vx = vx
        self.vy = vy
        self.x = x
...
objs = [obj(1000000, -0.1, 0, 200, 400, 50, (255, rand(255), rand(255)), "note.wav"),
        obj(1, 0, 0, 100, 400, 50, (255, rand(255), rand(255)), "note.wav")]
...
for i in sl:
    sound = sound.overlay(audio, position=int(i/FPS*1000))
